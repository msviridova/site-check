...
- `3:2` (широкий, 1536x1024)
- `2:3` (вертикальный, 1024x1536)
...
| `size` | string | Соотношение сторон изображения |
...
- **Генерация креативов (/creative):** 75 секунд
- **Генерация изображений (/image):** 120 секунд
...
- **Соотношения сторон изображений:** 1:1 (1024x1024), 3:2 (1536x1024), 2:3 (1024x1536)
...
- **Автоматическая генерация:** При запросе графических концептов изображения генерируются автоматически по предпочтительному соотношению сторон
- **Форматы ответа:** URL или Base64
- **Встроенные промпты:** Для графических концептов создаются оптимизированные промпты для разных соотношений сторон (1x1, 4x1, 1x2)
- **Автоматическое сохранение:** Сгенерированные изображения автоматически сохраняются локально и открываются (macOS)
